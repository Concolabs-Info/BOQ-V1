# Waterproofing and Other Floor Works — Measurement Rules

This file keeps the measurement and evidence rules for waterproofing and related floor works, including the special width/boundary treatment that must be handled by the deterministic rule engine rather than guessed by the model.
