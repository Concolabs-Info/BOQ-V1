...
export type BoqElementType = "door" | "window" | "wall_external" | "wall_internal" | "floor_finish" | "wall_finish" | "wall_decoration" | "floor" | "floor_work_screed" | "floor_work_waterproofing" | "floor_work_underlay" | "floor_work_board_insulation" | "floor_work_quilt_insulation" | "floor_work_isolation_membrane" | "floor_work_sealer" | "floor_work_skirting" | "ceiling_system" | "ceiling_finish" | "ceiling_decoration" | "ceiling_bulkhead" | "ceiling_beam" | "ceiling_strip" | "ceiling_upstand" | "ceiling_access_panel" | "ceiling_edge_trim" | "ceiling_angle_trim" | "ceiling_fire_barrier" | "ceiling_service_collar" | "ceiling_fitting" | "ceiling_shadow_gap" | "ceiling_cornice" | "ceiling_insulation" | "ceiling_repair" | "roof_sheet_covering" | "roof_tile_covering" | "roof_slate_covering" | "roof_waterproofing" | "roof_green_roof" | "roof_glazing" | "roof_insulation" | "roof_underlay" | "roof_battens" | "roof_decking" | "roof_sarking" | "roof_vapour_control" | "roof_ridge" | "roof_hip" | "roof_valley" | "roof_eave" | "roof_verge" | "roof_abutment" | "roof_flashing" | "roof_capping" | "roof_upstand" | "roof_downstand" | "roof_gutter" | "roof_channel" | "roof_outlet" | "roof_downpipe" | "rooflight" | "skylight" | "roof_access_hatch" | "roof_vent" | "roof_truss" | "roof_rafter" | "roof_purlin" | "roof_joist" | "roof_wall_plate" | "roof_fascia" | "roof_bargeboard" | "roof_soffit" | "roof_fall_arrest" | "roof_component" | "manual";

export const ROOF_BOQ_ELEMENT_TYPES = [
  "roof_sheet_covering", "roof_tile_covering", "roof_slate_covering", "roof_waterproofing",
  "roof_green_roof", "roof_glazing", "roof_insulation", "roof_underlay", "roof_battens",
  "roof_decking", "roof_sarking", "roof_vapour_control", "roof_ridge", "roof_hip",
  "roof_valley", "roof_eave", "roof_verge", "roof_abutment", "roof_flashing", "roof_capping",
  "roof_upstand", "roof_downstand", "roof_gutter", "roof_channel", "roof_outlet", "roof_downpipe", "rooflight",
  "skylight", "roof_access_hatch", "roof_vent", "roof_truss", "roof_rafter", "roof_purlin",
  "roof_joist", "roof_wall_plate", "roof_fascia", "roof_bargeboard", "roof_soffit",
  "roof_fall_arrest", "roof_component",
] as const satisfies readonly BoqElementType[];

export type BoqTemplateItem = {
  id: string;
  template_id: string;
  name: string;
  element_type: BoqElementType;
