...
export type FloorSummary = {
  ...
  counts: {
    ...
    walls: number;
    rooms: number;
    finish_assignments?: number;
    wall_finish_assignments?: number;
    floor_work_assignments?: number;
    roof_levels?: number;
    roof_planes?: number;
    ceiling_zones?: number;
    ceiling_assignments?: number;
    ceiling_features?: number;
