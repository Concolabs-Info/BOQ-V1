...
def _subjects(text: str) -> list[ViewportSubject]:
    ...
    mapping = {
        ...
        "RAMP": ViewportSubject.RAMP,
        "FLOOR": ViewportSubject.FLOOR,
        "CEILING": ViewportSubject.CEILING,
        "RCP": ViewportSubject.CEILING,
        "ROOF": ViewportSubject.ROOF,
        "ROOF STRUCTURE": ViewportSubject.ROOF_STRUCTURE,
