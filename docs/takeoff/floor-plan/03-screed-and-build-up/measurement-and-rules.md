# Screed and Floor Build-Up — Measurement Rules

This file keeps the measurement rules and NRM2 notes that must be applied after geometry and build-up evidence are confirmed. Model output is evidence; code performs the official quantity calculations.


## Floor measurement and NRM2 notes
