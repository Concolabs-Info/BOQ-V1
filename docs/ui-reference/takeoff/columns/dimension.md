...
- Height from the model. Top is the soffit they selected. On Ground, bottom is the pad — the stalk is included. Override if the pick was wrong
- Volume readout: `0.230 × 0.450 × height`
- Formwork readout: girth × height
