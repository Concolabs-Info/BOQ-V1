...
const boqSectionOptions: BoqSectionOption[] = [
  ...
  { key: "finishes", label: "31: Floor finishes", section_code: "31", section_name: "Floor finishes" },
  { key: "wall-finishes", label: "28: Wall finishes", section_code: "28", section_name: "28 Floor, wall, ceiling finishes" },
  { key: "decoration", label: "29: Decoration", section_code: "29", section_name: "29 Decoration" },
  { key: "general", label: "General", section_code: null, section_name: "Other items" },
];

const elementDefaults: Partial<Record<ElementType, ElementDefault>> = {
  wall_external: {
    name: "External Wall Template", unit: "m²", section_code: "14A", section_name: "Masonry – external walls",
    description_template: "[THICKNESS] mm thick [MATERIAL] external wall construction.",
  ...
  wall_internal: {
    ...
    description_template: "[THICKNESS] mm thick [MATERIAL] internal wall construction.",
  ...
  floor: {
    name: "Floor Finish Template", unit: "m²", section_code: "31", section_name: "Floor finishes",
  ...
  floor_work_screed: {
    name: "Floor Screed Template", unit: "m²", section_code: "28/1", section_name: "Screeds",
    description_template: "[THICKNESS] mm [FLOOR_WORK] to [ROOM_NAME].",
    keywords: ["floor", "screed", "bed"], formula: { operation: "value", variables: ["Quantity"], constant: null },
  },
  floor_work_waterproofing: {
    name: "Floor Waterproofing Template", unit: "m²", section_code: "19", section_name: "Waterproofing",
    description_template: "[FLOOR_WORK] to [ROOM_NAME], including joints and upturns.",
    keywords: ["floor", "waterproofing", "tanking"], formula: { operation: "value", variables: ["Quantity"], constant: null },
  },
  floor_work_underlay: {
    name: "Floor Underlay Template", unit: "m²", section_code: "28/34", section_name: "Underlays",
    description_template: "[FLOOR_WORK] underlay to [ROOM_NAME].",
    keywords: ["floor", "underlay"], formula: { operation: "value", variables: ["Quantity"], constant: null },
  },
  floor_work_board_insulation: {
    name: "Board Insulation Template", unit: "m²", section_code: "28/32", section_name: "Board insulation",
    description_template: "[THICKNESS] mm [FLOOR_WORK] to [ROOM_NAME].",
    keywords: ["floor", "board", "insulation"], formula: { operation: "value", variables: ["Quantity"], constant: null },
  },
  floor_work_quilt_insulation: {
    name: "Quilt Insulation Template", unit: "m²", section_code: "28/33", section_name: "Quilt insulation",
    description_template: "[THICKNESS] mm [FLOOR_WORK] to [ROOM_NAME].",
    keywords: ["floor", "quilt", "insulation"], formula: { operation: "value", variables: ["Quantity"], constant: null },
  },
  floor_work_isolation_membrane: {
    name: "Isolation Membrane Template", unit: "m²", section_code: "28/34", section_name: "Isolation membranes",
    description_template: "[FLOOR_WORK] to [ROOM_NAME], including laps and joints.",
    keywords: ["floor", "isolation", "membrane"], formula: { operation: "value", variables: ["Quantity"], constant: null },
  },
  floor_work_sealer: {
    name: "Floor Sealer Template", unit: "m²", section_code: "28/24", section_name: "Floor sealers",
    description_template: "[FLOOR_WORK] to [ROOM_NAME], [LAYER_COUNT] coat(s).",
    keywords: ["floor", "sealer", "coating"], formula: { operation: "value", variables: ["Quantity"], constant: null },
  },
  floor_work_skirting: {
    name: "Floor Skirting Template", unit: "m", section_code: "28/14", section_name: "Floor skirtings",
    description_template: "[HEIGHT] mm high [FLOOR_WORK] skirting to [ROOM_NAME].",
    keywords: ["floor", "skirting", "base"], formula: { operation: "value", variables: ["Quantity"], constant: null },
  },
  wall_finish: {
    name: "Wall Finish Template", unit: "m²", section_code: "28", section_name: "28 Floor, wall, ceiling finishes",
    description_template: "[LAYER]: [WALL_FINISH] to [ROOM_NAME] ([DIRECTION]).",
    keywords: ["wall", "finish", "tile", "cladding", "plaster"], formula: { operation: "value", variables: ["Quantity"], constant: null },
  },
  wall_decoration: {
    name: "Wall Decoration Template", unit: "m²", section_code: "29", section_name: "29 Decoration",
    description_template: "[LAYER]: [WALL_FINISH], [COLOUR], to [ROOM_NAME] ([DIRECTION]).",
    keywords: ["wall", "paint", "wallpaper", "decoration"], formula: { operation: "value", variables: ["Quantity"], constant: null },
  },
  manual: {
...
const elementTypeOptions: ElementType[] = ["wall_external", "wall_internal", "door", "window", "floor_finish", "floor_work_screed", "floor_work_waterproofing", "floor_work_underlay", "floor_work_board_insulation", "floor_work_quilt_insulation", "floor_work_isolation_membrane", "floor_work_sealer", "floor_work_skirting", "wall_finish", "wall_decoration", ...ROOF_BOQ_ELEMENT_TYPES, "ceiling_system", "ceiling_finish", "ceiling_decoration", "ceiling_bulkhead", "ceiling_beam", "ceiling_strip", "ceiling_upstand", "ceiling_access_panel", "ceiling_edge_trim", "ceiling_angle_trim", "ceiling_fire_barrier", "ceiling_service_collar", "ceiling_fitting", "ceiling_shadow_gap", "ceiling_cornice", "ceiling_insulation", "ceiling_repair", "manual"];
const defaultItems: ItemDraft[] = [
  createItemForType("wall_external"), createItemForType("wall_internal"), createItemForType("door"),
  createItemForType("window"), createItemForType("floor_finish"), createItemForType("floor_work_screed"),
  createItemForType("floor_work_waterproofing"), createItemForType("floor_work_underlay"), createItemForType("floor_work_board_insulation"),
  createItemForType("floor_work_quilt_insulation"), createItemForType("floor_work_isolation_membrane"), createItemForType("floor_work_sealer"),
  createItemForType("floor_work_skirting"), createItemForType("wall_finish"), createItemForType("wall_decoration"), createItemForType("manual"),
];
...
export function BoqTemplatesPage({ projectId }: { projectId: string }) {
  ...
  function updateItemDraftElementType(elementType: ElementType) {
    setItemDraft((current) => {
      ...
      const defaults = defaultsFor(elementType);
...
function normalizeItem(item: ItemDraft, index: number): ItemDraft {
  const defaults = defaultsFor(item.element_type);
...
function defaultConditionalRulesForType(elementType: ElementType): BoqConditionalRules { const defaults = defaultsFor(elementType); return { branches: [
...
function defaultsFor(elementType: ElementType): ElementDefault {
  const saved = elementDefaults[elementType];
  ...
  if ((ROOF_BOQ_ELEMENT_TYPES as readonly string[]).includes(elementType)) {
    ...
    return { name: `${formatElementType(elementType)} Template`, unit: isNumber ? "nr" : isLength ? "m" : "m²", section_code: "18", section_name: "Roof work", description_template: "[ROOF_LEVEL] – Provide [ROOF_ITEM] for [ROOF_SYSTEM]; [MATERIAL]; [PITCH]; including fixings and completion.", keywords: ["roof"], formula: { operation: "value", variables: ["Quantity"], constant: null } };
  }
  ...
  return { name: `${formatElementType(elementType)} Template`, unit: isNumber ? "nr" : isLength ? "m" : "m²", section_code: sectionCode, section_name: `${sectionCode} Ceiling work`, description_template: "Provide and install [CEILING_ITEM] for [CEILING_SYSTEM]; [MATERIAL]; [FINISH]; [SUSPENSION_BAND]; [HEIGHT_BAND].", keywords: ["ceiling"], formula: { operation: "value", variables: ["Quantity"], constant: null } };
}
