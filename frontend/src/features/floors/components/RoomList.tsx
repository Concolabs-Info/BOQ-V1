        ...
        <div className="space-y-2">
          {visible.map((room) => {
            ...
            <button
              ...
              className={selectedId === room.id ? "lazy-list-item w-full rounded-xl border border-blue-300 bg-blue-50 p-3 text-left" : "lazy-list-item w-full rounded-xl border border-slate-200 p-3 text-left hover:border-blue-200"}
            >
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  ...
                  <p className="mt-1 truncate text-xs text-slate-500">{room.room_type || "Room type not assigned"}</p>
                </div>
