...
export type SpecificationDrawingType = string;
export type DrawingTypeOption = { key: SpecificationDrawingType; label: string };
...
export type SupportingSource = {
  ...
  floor_ids: string[];
  drawing_types: SpecificationDrawingType[];
...
export type SpecificationCategory = {
  ...
  label: string;
  description: string;
  default_drawing_types: SpecificationDrawingType[];
  status: SpecificationStatus;
...
export type SpecificationsState = {
  ...
  floors: FloorOption[];
  drawing_types: DrawingTypeOption[];
