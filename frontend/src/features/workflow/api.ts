...
export function getWorkflowSummary(projectId: string): Promise<ProjectWorkflowSummary> {
  return requestJson<ProjectWorkflowSummary>(workflowPath(projectId, "/summary"));
}
